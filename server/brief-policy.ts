...
export function estimateResearchCost(brief: Pick<PlaylistBrief, "mode" | "targetSize">): number {
  if (brief.mode === "exhaustive") return 8;
  if (brief.mode === "hybrid" && (brief.targetSize === null || brief.targetSize.max > 100)) return 8;
  return 5;
}
