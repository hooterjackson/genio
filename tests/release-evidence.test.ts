...
function payload(
  ...
  const runtime = {
    ...
    policyVersions: {
      ...
      musicConcept: "music_concepts_v3_4_0",
  ...
  if (
    ...
    const convergenceObservation = (
      ...
      const runtime = {
        ...
        schemaPreferred: "19",
        workerProtocol: "playlist-pipeline-v12",
        minimumWorkerProtocol: "playlist-pipeline-v12",
...
function completedPublicRolloutEvidence(
  ...
  const rolloutPayload = {
    ...
    soak: {
      ...
      intentStageMetrics: {
        windowStartedAt: "2026-07-23T06:19:00.000Z",
        windowCompletedAt: "2026-07-23T12:19:00.000Z",
        eligibleSubmissionCount: 200,
        candidateAssignedCount: 100,
        exactCompletionCount: 100,
      },
    },
