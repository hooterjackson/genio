...
function command(phase: "bridge" | "expand"): string[] {
  return [
    ...
    "--phase", phase,
    "--expected-schema", phase === "expand" ? "20" : "19",
...
function observation(
  ...
  return {
    ...
    runtimeSchemaMaximum: "20",
    runtimeWorkerProtocol: "playlist-pipeline-v12",
    runtimeProofArchitectureMode: "shadow",
    ...
    proofArchitectureAuthority: "shadow",
